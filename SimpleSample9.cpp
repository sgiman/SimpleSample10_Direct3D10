...
void CALLBACK OnD3D9FrameRender( IDirect3DDevice9* pd3dDevice, double fTime, float fElapsedTime, void* pUserContext )
{
    ...
    if( SUCCEEDED( pd3dDevice->BeginScene() ) )
    {
		...
		// Обновить переменные эффекта. 
		// Вместо использования строк было бы более эффективно 
		// кэшировать дескриптор параметра, вызывая ID3DXEffect::GetParameterByName
